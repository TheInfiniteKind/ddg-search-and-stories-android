...
public class AppStateManager {
	...
	public static void recoverAppState(Object state, DuckDuckGoContainer duckDuckGoContainer) {
		...
		// do we ever get here?
			...
			duckDuckGoContainer.currentScreen = SCREEN.getByCode(prefs.getInt("currentScreen", SCREEN.SCR_WEBVIEW/*SCR_SEARCH_HOME_PAGE*//*SCREEN.SCR_STORIES*/.getCode()));
			duckDuckGoContainer.prevScreen = SCREEN.getByCode(prefs.getInt("prevScreen", SCREEN.SCR_WEBVIEW/*SCR_SEARCH_HOME_PAGE*//*SCREEN.SCR_STORIES*/.getCode()));
